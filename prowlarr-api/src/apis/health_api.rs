...
pub async fn api_v1_health_get(configuration: &configuration::Configuration, ) -> Result<Vec<models::HealthResource>, Error<ApiV1HealthGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1HealthGetError> = serde_json::from_str(&local_var_content).ok();
