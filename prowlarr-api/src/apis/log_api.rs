...
/// struct for typed errors of method [`api_v1_log_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ApiV1LogGetError {
    UnknownValue(serde_json::Value),
}


pub async fn api_v1_log_get(configuration: &configuration::Configuration, page: Option<i32>, page_size: Option<i32>, sort_key: Option<&str>, sort_direction: Option<models::SortDirection>, level: Option<&str>) -> Result<models::LogResourcePagingResource, Error<ApiV1LogGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV1LogGetError> = serde_json::from_str(&local_var_content).ok();
